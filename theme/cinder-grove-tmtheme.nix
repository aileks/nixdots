let
  colors = import ./cinder-grove.nix;
in
''
  ...
  <dict>
    <key>author</key>
    <string>Caspian Harper</string>
    <key>colorSpaceName</key>
    <string>sRGB</string>
    <key>name</key>
    <string>Cinder Grove</string>
    <key>semanticClass</key>
    <string>theme.dark.cinder-grove</string>
    <key>settings</key>
    <array>
      <dict>
        <key>settings</key>
        <dict>
          ...
          <string>${colors.bright}A5</string>
          ...
          <key>invisibles</key>
          <string>${colors.muted}</string>
          <key>lineHighlight</key>
          <string>${colors.surface}</string>
          <key>selection</key>
          <string>${colors.surface}</string>
          <key>selectionBorder</key>
          <string>${colors.container}</string>
          <key>tagsOptions</key>
      ...
      <dict>
        ...
        <dict>
          <key>foreground</key>
          <string>#C87546</string>
        </dict>
      </dict>
      <dict>
        <key>scope</key>
        <string>keyword, keyword.operator.new, variable.language.super, support.type.primitive, storage.type, storage.modifier, punctuation.definition.keyword</string>
        <key>settings</key>
        <dict>
          <key>fontStyle</key>
          <string></string>
      ...
      <dict>
        ...
        <dict>
          <key>foreground</key>
          <string>${colors.secondary}</string>
        </dict>
      </dict>
      <dict>
        <key>name</key>
      ...
      <dict>
        <key>name</key>
        <string>Decorator punctuations</string>
        <key>scope</key>
    ...
    <key>uuid</key>
    <string>b3437e78-ba04-4c87-b602-b41da2f987f8</string>
  </dict>
  </plist>
''
