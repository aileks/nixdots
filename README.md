...
`Mod` is the Super key. Stock dwm keybinds (focus, resize, tags, layouts on their usual keys) are not listed.

### Apps and tools

| Keys | Action |
| --- | --- |
| `Mod + Space` | dmenu app launcher |
...
| `Mod + Ctrl + J` / `Mod + Ctrl + K` | grow or shrink a window |
